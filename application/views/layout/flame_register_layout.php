...
<head>
    ...
    <script type="text/javascript">
        var BlzCookieConsent = {
            host: 'battle.net',
            onetrustScriptUrl: 'https://cdn.cookielaw.org/langswitch/06b5cc84-67ee-4c33-8c20-75d78f201905.js',
    ...
    <script src="https://cdn.optimizely.com/js/8607492459.js" type="text/plain" class="optanon-category-2"></script>
    <input id="blzArkoseHealthy" type="hidden" value="true" />
    <script type="text/javascript" src="//blizzard-api.arkoselabs.com/v2/E8A75615-1CBA-5DFF-8032-D16BCF234E10/api.js" data-callback="blzArkoseEnforcement" async defer></script>
...
<body class="us es-es wow-template web creation" data-embedded-state="STATE_ACCOUNT_CREATION" data-analytics-view="/creation/account-creation">
    <script type="text/javascript">
        "use strict";
        ! function(n) {
            var a = "/account/creation/error-report";
            ...
            function c() {
                return {
                    system: function() {
                        var r = {};
                        r.clientTimeMillis = Date.now();
                        var e = n.navigator;
                        return o(r, e, "oscpu"), o(r, e, "hardwareConcurrency"), o(r, e, "deviceMemory"), r
                    }(),
                    network: function() {
                        var r = {},
                            e = n.navigator.connection;
                        return void 0 !== e && (o(r, e, "downlink"), o(r, e, "downlinkMax"), o(r, e, "effectiveType"), o(r, e, "rtt"), o(r, e, "type")), r
                    }(),
                    browser: function() {
                        var r = {};
                        o(r, n && n.location, "href"), o(r, window, "devicePixelRatio"), o(r, window, "innerHeight"), o(r, window, "innerWidth");
                        var e = n.navigator;
                        return o(r, e, "platform"), o(r, e, "userAgent"), o(r, e, "language"), o(r, e, "cookieEnabled"), r
                    }()
                }
            }

            function r(r, e, n, o, t) {
                var i = function(r, e, n, o) {
                    return {
                        message: r,
                        source: e,
                        lineno: n,
                ...
                ! function(r) {
                    console.info("An error occurred. Submitting report.");
                    var e = new XMLHttpRequest;
                    e.open("POST", a), e.setRequestHeader("Content-Type", "application/json"), e.setRequestHeader("Accept", "application/json"), e.addEventListener("error", function(r) {
                        console.error("An error occurred while sending an error-report. Error: " + r)
            ...
            void 0 !== n ? (n.onerror = r, n.errorReporter = {
                global: r
            }, console.debug("Listening for unhandled errors...")) : console.error('Unable to bind onError listener as "window" was undefined.')
        }(window, document);
    </script>
    <script>
        //<![CDATA[
        ...
        dataLayer.push({
            "analyticsViewName": "\/creation/account-creation:/creation/wow-start",
            "analyticsRequestUri": "\/account/creation/es/tos.html",
            "userAgent": "web",
            "authenticated": "0",
            "input-order": "NULL",
            "error-box": "NULL",
    ...
    <script>
        ...
        (function() {
            ...
            if (typeof window.phoenix !== 'undefined') {
                ...
                applyPhoenixGaClientId();
            }
        })();

        function applyPhoenixGaClientId() {
            if (typeof ga === 'function') {
                ga('create', 'GTM-589KTQ', 'auto', 'phoenixTracker', AppAnalyticsPackage);
                ga(function() {
                ...
                setTimeout(applyPhoenixGaClientId, 150);
            }
        }
        //]]>
    </script>
    ...
    <div id="layout-middle">
        <div class="wrapper">
            <div id="content">
                ...
                <div class="templates">
                    <div id="error" class="alert alert-error alert-icon"></div>
                </div>
                <script type="text/javascript">
                    //<![CDATA[
                    var formStatus,
                        ...
                        messages = {
                            "passwordrequirements": {
                                "length": {
                                    "code": "account.creation.passwordrequirements.length",
                                    "message": "Usa entre 8 y 16 caracteres."
                                },
                                "alphanumeric": {
                                    "code": "account.creation.passwordrequirements.alphanumeric",
                                    "message": "Debes usar al menos un número y un carácter alfabético."
                                },
                                "specialchars": {
                                    "code": "account.creation.passwordrequirements.specialchars",
                                    "message": "No uses caracteres especiales."
                                },
                                "similarname": {
                                    "code": "account.creation.passwordrequirements.similarname",
                                    "message": "No utilices una contraseña similar a tu nombre de cuenta."
                                }
                            },
                            "errors": {
                                "header": {
                                    "code": "account.creation.error.header",
                                    "message": "¡Ups! Esto necesita tu atención:"
                                },
                                "blank": {
                                    "code": "account.creation.error.blank",
                                    "message": "Los campos del formulario son obligatorios."
                                },
                                "country": {
                                    "code": "account.creation.countryChange.error",
                                    "message": "Debes seleccionar un país de residencia."
                                },
                                "email": {
                                    "code": "error.email.format",
                                    "message": "Esta dirección de correo electrónico no es válida."
                                },
                                "emailMatch": {
                                    "code": "error.email.match",
                                    "message": "Las direcciones de correo electrónico no coinciden."
                                },
                                "similar": {
                                    "code": "error.email.similar",
                                    "message": "Tu contraseña no puede ser igual que tu dirección de correo electrónico."
                                },
                                "captcha": {
                                    "code": "error.captcha.failed",
                                    "message": "El código de seguridad introducido no es válido. Vuelve a intentarlo."
                                },
                                "rePassword": {
                                    "code": "account.creation.error.rePassword",
                                    "message": "Las contraseñas deben coincidir."
                                },
                                "password": {
                                    "code": "account.creation.error.password",
                                    "message": "Contraseña no válida."
                                },
                                "age": {
                                    "code": "account.creation.error.age",
                                    "message": "Debes introducir tu edad en números."
                                },
                                "agreements": {
                                    "code": "account.creation.agreements.error.chat",
                                    "message": "Para continuar, debes aceptar los acuerdos anti-trampa y sobre el uso de chat."
                                },
                                "unknown": {
                                    "code": "error.unknown",
                                ...
                                "sms": {
                                    "code": "error.sms.format",
                                    "message": "This is not a valid mobile number."
                                },
                                "smsTaken": {
                                    "code": "error.sms.taken",
                                    "message": "This mobile number is already in use."
                                },
                                "serverError": {
                                    "code": "error.403.desc",
                                    "message": "¡Vaya! Parece que algo no ha ido del todo bien. Danos unos minutos y vuelve a intentarlo después."
                                },
                                "countryCode": {
                                    "code": "error.sms.countryCode.format",
                    ...
                    $(function() {
                        ...
                        countryChange = Country.create({
                            "defaultCountry": <?php echo (!is_null($this->input->get('country'))) ? $this->input->get('country'): 232; ?>,
                            "placeholder": false,
    ...
    <div class="NavbarFooter is-region-limited" data-timestamp="1579802638659" data-hash="d0c6275ff3e7ff52f20344207160e1c4b2437836" data-region-selection="limited" data-region="us" data-locale="es-es" data-geoip-service-url="https://geo.battle.net">
            ...
            <div class="NavbarFooter-selectorDropdown">
                <div class="NavbarFooter-selectorDropdownContainer">
                    ...
                    <div class="NavbarFooter-selectorRegions NavbarFooter-selectorSection">
                        ...
                        <a class="NavbarFooter-selectorRegion is-active is-selected NavbarFooter-selectorOption " data-id="us">
                        ...
                        <a class="NavbarFooter-selectorRegion NavbarFooter-selectorOption " data-id="eu">
                    ...
                    <div class="NavbarFooter-selectorLocales NavbarFooter-selectorSection">
                        ...
                        <div class="NavbarFooter-selectorSectionPage is-open is-active " data-region="us">
                            <div class="NavbarFooter-selectorSectionBlock">
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/de-de/tos.html" data-id="de-de" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/en-us/tos.html" data-id="en-us" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/en-gb/tos.html" data-id="en-gb" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale is-active is-selected NavbarFooter-selectorOption " href="//us.battle.net/account/creation/es-es/tos.html" data-id="es-es" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/es-mx/tos.html" data-id="es-mx" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/fr-fr/tos.html" data-id="fr-fr" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/it-it/tos.html" data-id="it-it" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/pt-br/tos.html" data-id="pt-br" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/pt-pt/tos.html" data-id="pt-pt" data-alias="">
                            ...
                            <div class="NavbarFooter-selectorSectionBlock">
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/pl-pl/tos.html" data-id="pl-pl" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Polski</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                        </svg>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/ru-ru/tos.html" data-id="ru-ru" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/ko-kr/tos.html" data-id="ko-kr" data-alias="">
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/th-th/tos.html" data-id="th-th" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">ภาษาไทย</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                        </svg>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/ja-jp/tos.html" data-id="ja-jp" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">日本語</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                        </svg>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//us.battle.net/account/creation/zh-tw/tos.html" data-id="zh-tw" data-alias="">
                        ...
                        <div class="NavbarFooter-selectorSectionPage " data-region="eu">
                            <div class="NavbarFooter-selectorSectionBlock">
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/de-de/tos.html" data-id="de-de" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Deutsch</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/en-us/tos.html" data-id="en-us" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">English (US)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/en-gb/tos.html" data-id="en-gb" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">English (EU)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/es-es/tos.html" data-id="es-es" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Español (EU)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/es-mx/tos.html" data-id="es-mx" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Español (AL)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/fr-fr/tos.html" data-id="fr-fr" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Français</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/it-it/tos.html" data-id="it-it" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Italiano</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/pt-br/tos.html" data-id="pt-br" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Português (AL)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/pt-pt/tos.html" data-id="pt-pt" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Português (EU)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                            ...
                            <div class="NavbarFooter-selectorSectionBlock">
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/pl-pl/tos.html" data-id="pl-pl" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Polski</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/ru-ru/tos.html" data-id="ru-ru" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Русский</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/ko-kr/tos.html" data-id="ko-kr" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">한국어</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/th-th/tos.html" data-id="th-th" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">ภาษาไทย</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/ja-jp/tos.html" data-id="ja-jp" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">日本語</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//eu.battle.net/account/creation/zh-tw/tos.html" data-id="zh-tw" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">繁體中文</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                        ...
                        <div class="NavbarFooter-selectorSectionPage " data-region="kr">
                            <div class="NavbarFooter-selectorSectionBlock">
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/de-de/tos.html" data-id="de-de" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Deutsch</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/en-us/tos.html" data-id="en-us" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">English (US)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/en-gb/tos.html" data-id="en-gb" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">English (EU)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/es-es/tos.html" data-id="es-es" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Español (EU)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/es-mx/tos.html" data-id="es-mx" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Español (AL)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/fr-fr/tos.html" data-id="fr-fr" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Français</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/it-it/tos.html" data-id="it-it" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Italiano</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/pt-br/tos.html" data-id="pt-br" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Português (AL)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/pt-pt/tos.html" data-id="pt-pt" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Português (EU)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                            ...
                            <div class="NavbarFooter-selectorSectionBlock">
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/pl-pl/tos.html" data-id="pl-pl" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Polski</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/ru-ru/tos.html" data-id="ru-ru" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Русский</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/ko-kr/tos.html" data-id="ko-kr" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">한국어</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/th-th/tos.html" data-id="th-th" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">ภาษาไทย</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/ja-jp/tos.html" data-id="ja-jp" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">日本語</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//kr.battle.net/account/creation/zh-tw/tos.html" data-id="zh-tw" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">繁體中文</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                        ...
                        <div class="NavbarFooter-selectorSectionPage " data-region="tw">
                            <div class="NavbarFooter-selectorSectionBlock">
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/de-de/tos.html" data-id="de-de" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Deutsch</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/en-us/tos.html" data-id="en-us" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">English (US)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/en-gb/tos.html" data-id="en-gb" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">English (EU)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/es-es/tos.html" data-id="es-es" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Español (EU)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/es-mx/tos.html" data-id="es-mx" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Español (AL)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/fr-fr/tos.html" data-id="fr-fr" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Français</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/it-it/tos.html" data-id="it-it" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Italiano</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/pt-br/tos.html" data-id="pt-br" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Português (AL)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/pt-pt/tos.html" data-id="pt-pt" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Português (EU)</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                            ...
                            <div class="NavbarFooter-selectorSectionBlock">
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/pl-pl/tos.html" data-id="pl-pl" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Polski</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/ru-ru/tos.html" data-id="ru-ru" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">Русский</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/ko-kr/tos.html" data-id="ko-kr" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">한국어</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/th-th/tos.html" data-id="th-th" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">ภาษาไทย</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/ja-jp/tos.html" data-id="ja-jp" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">日本語</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                                ...
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//tw.battle.net/account/creation/zh-tw/tos.html" data-id="zh-tw" data-alias="">
                                    <div class="NavbarFooter-selectorOptionLabel">繁體中文</div>
                                    <div class="NavbarFooter-selectorOptionCheck NavbarFooter-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false">
                                            <use xlink:href="#Navbar-icon-check"></use>
                        ...
                        <div class="NavbarFooter-selectorSectionPage " data-region="cn">
                            <div class="NavbarFooter-selectorSectionBlock">
                                <a class="NavbarFooter-selectorLocale NavbarFooter-selectorOption " href="//cn.battle.net/account/creation/zh-cn/tos.html" data-id="zh-cn" data-alias="">
        ...
        <div class="NavbarFooter-legal" data-disable-additional="false" data-disable-legal="false" data-legal-id="1112425812" data-legal-url="https://navbar.blizzard.com/api/v4/nav/rating" data-country="CRI">
            es-ES
            <div class="NavbarFooter-legalRatings">
            </div>
        </div>
    </div>
    <script type="text/javascript" src="//bnetus-a.akamaihd.net/account/creation/static/js/account-creation/account-creation.min.0toEX.js"></script>
    <script type="text/javascript" src="//bnetus-a.akamaihd.net/account/creation/static/js/account-creation/zxcvbn.min.0S2nW.js"></script>
    <script type="text/javascript" src="//bnetus-a.akamaihd.net/account/creation/static/js/account-creation/password-requirements.min.13FcS.js"></script>
    <script type="text/javascript" src="//bnetus-a.akamaihd.net/account/creation/static/js/toolkit/toolkit-select.4ECdw.js"></script>
    <script type="text/javascript" src="https://us.battle.net/account/creation/static/js/ab-testing-optimizely/event-api.js"></script>
    <script type="text/javascript" src="https://us.battle.net/account/creation/static/js/navbar.min.js"></script>
    <script src="https://us.battle.net/account/creation/static/js/embedded-javascript/embed-0.1.5.min.js"></script>
    <script type="text/javascript" src="//bnetus-a.akamaihd.net/account/creation/static/js/account-creation/arkose-labs.min.3oiXQ.js"></script>
    <script type="text/javascript">
        window.dispatchEvent(new CustomEvent('navbarAddFooterLinks', {
            detail: {
                secondary: [{
                    text: 'Cookies',
                    href: '/account/creation/cookies'
                }]
            }
        }));
    </script>
