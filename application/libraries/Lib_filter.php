...
class lib_filter
{
    ...
    var $allowed = array('a' => array('href', 'target'), 'b' => array(), 'img' => array('src', 'width', 'height', 'alt', 'id', 'class'), 'div' => array('style', 'id', 'class'), 'style' => array(), 'span' => array('style', 'class'), 'br' => array(), 'p' => array('style'), 'i' => array(), 'em' => array(), 'table' => array('class', 'width', 'height', 'bgcolor', 'cellpadding', 'cellspacing', 'border', 'align', 'style'), 'tbody' => array(), 'th' => array('class', 'width', 'height', 'bgcolor', 'align'), 'tr' => array('class', 'width', 'height', 'bgcolor', 'align'), 'td' => array('class', 'width', 'height', 'bgcolor', 'align'), 'ul' => array(), 'li' => array(), 'ol' => array(), 'center' => array(), 'strong' => array(), "iframe" => array("src", "width", "height", "alt"));
    
    /**
     * tags which should always be self-closing (e.g. "<img />")
     */
    
    var $no_close = array('img', 'br');
    
    /**
     * tags which must always have seperate opening and closing tags (e.g. "<b></b>")
     */
    
    var $always_close = array('a', 'b', 'div', 'style', 'p', 'table', 'tr', 'td', 'th', 'ul', 'li', 'ol', 'center', 'strong', 'iframe', 'span', 'tbody', 'th');
    
    /**
     * attributes which should be checked for valid protocols
     */
    
    var $protocol_attributes = array('src', 'href');
    
    /**
     * protocols which are allowed
     */
    
    var $allowed_protocols = array('http', 'https');
    
    /**
     * tags which should be removed if they contain no content (e.g. "<b></b>" or "<b />")
     */
    
    var $remove_blanks = array('a', 'b');
    ...
    var $allowed_entities = array('amp', 'gt', 'lt', 'quot', 'aelig', 'oslash', 'aring', 'AElig', 'Oslash', 'Aring', 'nbsp', 'Agrave', 'Aacute', 'Acirc', 'Atilde', 'Auml', 'Aring', 'AElig', 'Ccedil', 'Egrave', 'Eacute', 'Ecirc', 'Euml', 'Igrave', 'Iacute', 'Icirc', 'Iuml', 'ETH', 'Ntilde', 'Ograve', 'Oacute', 'Ocirc', 'Otilde', 'Ouml', 'times', 'Oslash', 'Ugrave', 'Uacute', 'Ucirc', 'Uuml', 'Yacute', 'THORN', 'szlig', 'agrave', 'aacute', 'acirc', 'atilde', 'auml', 'aring', 'aelig', 'ccedil', 'egrave', 'eacute', 'ecirc', 'euml', 'igrave', 'iacute', 'icirc', 'iuml', 'eth', 'ntilde', 'ograve', 'oacute', 'ocirc', 'otilde', 'ouml', 'divide', 'oslash', 'ugrave', 'uacute', 'ucirc', 'uuml', 'yacute', 'thorn', 'yuml', 'zwnj', 
    // French
        'Agrave', 'agrave', 'Acirc', 'acirc', 'AElig', 'aelig', 'Ccedil', 'ccedil', 'Egrave', 'egrave', 'Eacute', 'eacute', 'Ecirc', 'ecirc', 'Euml', 'euml', 'Icirc', 'icirc', 'Iuml', 'iuml', 'Ocirc', 'ocirc', 'OElig', 'oelig', 'Ugrave', 'ugrave', 'Ucirc', 'ucirc', 'Uuml', 'uuml', 'laquo', 'raquo', 'euro', 
    // Greek
        'alpha', 'beta', 'gamma', 'delta', 'epsilon', 'zeta', 'eta', 'theta', 'iota', 'kappa', 'lambda', 'mu', 'nu', 'xi', 'omicron', 'pi', 'rho', 'sigma', 'tau', 'upsilon', 'phi', 'chi', 'psi', 'omega', 'sigmaf', 'thetasym', 'upsih', 'piv', 'Eta', 'Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta', 'Theta', 'Iota', 'Kappa', 'Lambda', 'Mu', 'Nu', 'Xi', 'Omicron', 'Pi', 'Rho', 'Sigma', 'Tau', 'Upsilon', 'Phi', 'Chi', 'Psi', 'Omega', 
    // Italian
        'Agrave', 'Egrave', 'Eacute', 'Igrave', 'Ograve', 'Oacute', 'Ugrave', 'agrave', 'egrave', 'eacute', 'igrave', 'ograve', 'oacute', 'ugrave', 'Scaron', 'scaron');
    ...
    public function _escape_comments($matches)
    {
    ...
    public function escape_comments($data)
    {
        ...
        $data = preg_replace_callback("/<!--(.*?)-->/s", array(
            $this,
            "_escape_comments"
        ), $data);
    ...
    public function _process_tags($matches)
    {
    ...
    /**
     * this public function removes certain tag pairs if they have no content. for instance,
    ...
    /**
     * this public function is called in two places - inside of each href-like
    ...
    public function _validate_entities_cb($matches)
    {
    ...
    public function validate_entities($data, $in_attribute)
    {
        ...
        /* Hotfix for deprecated e */
        
        $data = preg_replace_callback('!&([^&;]*)(?=(;|&|$))!', array(
            $this,
            "_validate_entities_cb"
        ), $data);
    ...
    /**
     * this public function comes last in processing, to clean up data outside of tags.
     */
    ...
    /**
     * this public function gets passed the 'inside' and 'end' of a suspected 
    ...
    /**
     * this public function determines whether the body of an entity (the
    ...
    public function removeHTML($message)
    {
